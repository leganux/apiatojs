    ...
    aggregate<T extends Model>(
        ...
        return async (req, res) => {
            ...
            try {
                ...
                const { where, whereObject, like, select, paginate, sort } = req.query;
                ...
                let elements = await model.findAll(query);

                if (fOut && typeof fOut === 'function') {
                    elements = await fOut(elements as T[]);
                }
